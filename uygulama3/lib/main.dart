...
class MyApp extends StatelessWidget {
      ...
      child: Column(
        children: [
          ...
          SingleChildScrollView(
            ...
            child: Row(
              children: [
                locationitem("assets/image/manzara1.jpg", "Malatya Kopru",
                    "7km from you", "₺ 14"),
                locationitem(
                    "assets/image/trabzon.jpg", "Trabzon", "12km from you", "₺ 19"),
                locationitem(
                    "assets/image/malatya.jpg", "Bağcılar", "4km from you", "₺ 25"),
                locationitem(
                    "assets/image/manzara1.jpg", "Malatya", "9km from you", "₺ 66"),
                locationitem("assets/image/trabzon.jpg", "Trabzon Kopru",
                    "7km from you", "₺ 14"),
              ],
            ),
          )
      ...
      child: Column(
        children: [
          ...
          SingleChildScrollView(
            ...
            child: Row(
              children: [
                locationitem("assets/image/malatya.jpg", "Malatya Kopru",
                    "7km from you", "₺ 14"),
                locationitem(
                    "assets/image/trabzon.jpg", "Trabzon", "12km from you", "₺ 19"),
                locationitem(
                    "assets/image/manzara1.jpg", "Bağcılar", "4km from you", "₺ 25"),
                locationitem(
                    "assets/image/malatya.jpg", "Malatya", "9km from you", "₺ 66"),
                locationitem("assets/image/trabzon.jpg", "Trabzon Kopru",
                    "7km from you", "₺ 14"),
              ],
            ),
  ...
  Widget locationitem(String photo, String title, String description, String fiyat) =>
      Container(
        width: 165,
    ...
    child: Column(
      ...
      children: [
        ...
        SingleChildScrollView(
          ...
          child: Row(
            children: [
              storyitem("assets/image/1.jpg", "Ayşe"),
              storyitem("assets/image/6.jpg", "Gökay"),
              storyitem("assets/image/2.jpg", "Fatma"),
              storyitem("assets/image/7.jpg", "Sena"),
              storyitem("assets/image/3.jpg", "Deniz"),
              storyitem("assets/image/8.jpg", "Mustafa"),
              storyitem("assets/image/4.jpg", "Caner"),
              storyitem("assets/image/6.jpg", "Keyvan"),
              storyitem("assets/image/5.jpg", "Ahmet"),
              storyitem("assets/image/1.jpg", "Ayşe"),
              storyitem("assets/image/10.jpg", "Mehmet"),
              storyitem("assets/image/2.jpg", "Fatma"),
            ],
          ),
        ),
